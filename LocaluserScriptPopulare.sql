...
---------------------------------------------------------------------------------------------------
 ...
 commit;
 ---------------------------------------------------------------------------------------------------
      DBMS_OUTPUT.PUT_LINE('Inserare 1 000 000 linii in tabela Books...');
    for v_i in 1..1000000 loop
      ...
      v_AuthorID := trunc(DBMS_RANDOM.VALUE(0,7499))+1;
...
--------------------------------------------------------------------------------------------------
  ...
  commit;*/
---------------------------------------------------------------------------------------------------
 	DBMS_OUTPUT.PUT_LINE('Inserare 100000 de linii in tabela Readers...');
    ...
    insert into Readers values(v_i, v_prenume, v_nume, v_user, Encrypt_string(v_password), v_data_nastere, 0);
...
---------------------------------------------------------------------------------------------------
  ...
  commit;
    DBMS_OUTPUT.PUT_LINE('Inserare 1000000 linii in tabela ReadBooks. Si Concomitent Books Borrowed..');
    for v_i in 1..1000000 loop
      v_readerID := TRUNC(DBMS_RANDOM.VALUE(0, 99998))+1;
      v_bookID := TRUNC(DBMS_RANDOM.VALUE(0, 999998))+1;
...
select * from readbooks r where r.booksid < 6;

0.62
2.89
9 8.3
select count(*), booksid from ReadBooks group by BOOKSID
order by 1 desc;

select * from readbooks where booksid = 758118 order by rating;

select * from books where id = 7568;
select * from readbooks where booksid = 7568;
*/
...
select * from SubGenres order by id desc;
select * from Authors order by id desc;
select * from ReadBooks;
select * from Readers order by id desc;

select count(*) from Books;
select count(*) from BooksBorrowed;
select count(*) from Genres order by id desc;
select count(*) from SubGenres order by id desc;
select count(*) from Authors order by id desc;
select count(*) from ReadBooks;
select count(*) from Readers order by id desc;



ALTER TABLESPACE users
    ADD DATAFILE 'D:\Programe\Datafile\usersGb.dbf' SIZE 1000M
      AUTOEXTEND ON
      NEXT 512K
      MAXSIZE 2000M;

ALTER TABLESPACE users
    ADD DATAFILE 'D:\Programe\Datafile\usersGb2.dbf' SIZE 500M
      AUTOEXTEND ON
      NEXT 512K
      MAXSIZE 2000M;
ALTER TABLESPACE users
    ADD DATAFILE 'D:\Programe\Datafile\usersGb3.dbf' SIZE 3000M
      AUTOEXTEND ON
      NEXT 512K
      MAXSIZE 4000M;
      
 ALTER TABLESPACE undotbs1 ADD DATAFILE 'D:\Programe\Datafile/undotbs1.dbf' SIZE 4G;
*/